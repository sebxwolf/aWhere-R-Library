#' @title GetWeatherNormsFields.
#'
#' @description
#' \code{GetWeatherNormsFields} calls Historic Weather Norms Endpoint of API using Field Location Construct
#'
#' @details
...
#'
#' @examples
#' GetWeatherNormsFields('field123','07-01', '07-10', '2008', '2015','2010,2011')

#' @export


GetWeatherNormsFields <- function(fieldId, monthDayStart = '', monthDayEnd = '',
